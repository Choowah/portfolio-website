            ...
            <div className="p-10">
                ...
                <div className="text-[#817F75] border-t border-[#B3B5BB] py-3">
                    <div className="">
                        ...
                        <Link to='https://github.com/Choowah/portfolio-website' className="underline">Source Code</Link>
                    ...
                    <div className='border-t border-[#B3B5BB]'>
                        ...
                        <Link to='https://github.com/Choowah/calcalories/' className="underline">Source Code</Link>
                        <h3 className="font-bold">Technologies Used</h3>
